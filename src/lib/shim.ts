...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    h1 { color: #1a1a1a; font-size: 22px; font-weight: 700; margin-bottom: 16px; letter-spacing: -0.5px; }
    .instruction {
      font-size: 15px;
      color: #555555;
      margin-bottom: 16px;
    ...
    @keyframes tap {
      ...
      50% { transform: translate(-3px, -3px) scale(0.9); opacity: 1; }
    }
    .cta-button {
      display: block;
      width: 100%;
    ...
    @media (max-width: 480px) {
      ...
      .screenshot-container { max-width: 260px; }
      .cta-button { font-size: 17px; padding: 14px 20px; }
      .tap-cursor { width: 28px; height: 28px; }
    }
  </style>
</head>
<body>
  <div class="container">
    ...
    <h1>${safeTitle}</h1>
    <p class="instruction">You'll have to do this twice. When this pops up, tap <strong>Open</strong>.</p>
    <a href="${safeDeepLink}" id="screenshotLink">
      <div class="screenshot-container">
        <img src="https://raw.githubusercontent.com/MediumMasala/linkedin-whatsapp-redirect/main/Screenshot.jpeg" alt="Tap Open when you see this popup" class="screenshot-img">
        <div class="scan-line"></div>
        <div class="retry-highlight"></div>
        <div class="tap-cursor">
          <svg viewBox="0 0 24 24" width="32" height="32">
            <path fill="#000000" stroke="#ffffff" stroke-width="1" d="M4 2l14 11-6 1 4 8-3 1-4-8-5 4V2z"/>
          </svg>
        </div>
      </div>
    </a>
